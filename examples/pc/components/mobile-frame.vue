<template>
  <div class="docs-simulator">
    <div class="nav">
      <div class="url" @click="openMobileWindow">
        {{ baseOrigin }}
      </div>
      <div class="refresh" @click="refreshIFrame"></div>
    </div>
    <div class="iframe-wrap">
      <iframe id="mobileIframe" :src="baseUrl + 'mobile.html#/index'" frameborder="0"></iframe>
    </div>
    <!-- <vue-cards-icon
      name="close"
